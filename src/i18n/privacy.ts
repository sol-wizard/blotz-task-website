    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "email", label: "Email:", address: "blotztask.app@gmail.com" },
        {
          ...
          text: "Or message us on Red Note →",
        },
        { type: "p", text: "We reply to email within 15 days. For anything involving your account or personal information, please use email rather than a social channel, so your details stay between you and us." },
      ],
    },
  ],
};
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "p", text: "邮件我们会在 15 天内回复。涉及您的账号或个人信息的事情，请走邮件，不要在社交平台上说，这样您的信息只有我们看得到。" },
      ],
    },
  ],
};
